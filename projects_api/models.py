...
class Material(models.Model):
    ...
    product_uuid = models.CharField(max_length=60, null=True)
    activity_uuid = models.CharField(max_length=60, null=True)
    geography = models.CharField(max_length=150, null=True)
    geography_name = models.CharField(max_length=255, null=True)
    unit_name = models.CharField(max_length=255, null=True)
    sector = models.CharField(max_length=255, null=True)
    cpc_classification = models.CharField(max_length=255, null=True)
    gwp = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    odp = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    ap = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    ep = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    pocp = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    adpe = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    adpf = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    faetp = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    maetp = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    tetp = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    htp = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    pere = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    perm = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    penre = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    penrm = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    penrt = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    sm = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    rsf = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    nrsf = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    fw = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    hwd = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    nhwd = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    rwd = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    cru = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    mfr = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    mer = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    eee = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    eet = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    gwptotal_a2 = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    gwpbiogenic_a2 = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    gwpfossil_a2 = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    gwpluluc_a2 = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    odp_a2 = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    ap_a2 = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    epmarine_a2 = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    epfreshwater_a2 = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    epterrestrial_a2 = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    pocp_a2 = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    adp_fossil_a2 = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    wdp_a2 = models.FloatField(null= True, help_text="Valor de tipo double precision.")
    nom15804_a2 = models.BooleanField(default=False)
